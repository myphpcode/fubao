<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\php\wamp\www\fubao\public/../application/index\view\cate\index.htm";i:1551929507;s:70:"D:\php\wamp\www\fubao\public/../application/index\view\common\head.htm";i:1551858548;s:71:"D:\php\wamp\www\fubao\public/../application/index\view\common\right.htm";i:1551859553;s:72:"D:\php\wamp\www\fubao\public/../application/index\view\common\footer.htm";i:1551860516;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <title>安阳妇幼__<?php echo $cates['cate_name']; ?></title>
        ...
        <div class="hide-on-med-and-down" style="position: fixed;width: 100%;background-color: #fff;">
            ...
            <div class="container ">
                <ul class="clearfix">
                    ...
                    <li class="nav">
                        <a href="<?php echo url('index/about/index',array('id'=>1)); ?>" class="O-nav">医院概况</a>
                        <ul class="nav-2">

                            <li><a href="<?php echo url('index/about/index',array('id'=>1)); ?>" class="omit">医院简介</a></li>
                            <li><a href="<?php echo url('index/about/index',array('id'=>2)); ?>" class="omit">现任领导</a></li>
                            <li><a href="<?php echo url('index/about/index',array('id'=>3)); ?>" class="omit">联系我们</a></li>
...
<div class="Wbox por container">
    <div class="row">
        <div class="Wtab wow bounceIn col s12 m12 l9 xl10" id="Ttab">
            <ul class="clearfix">
                <?php if($cates['pid'] != 0): if(is_array($scate) || $scate instanceof \think\Collection || $scate instanceof \think\Paginator): $i = 0; $__LIST__ = $scate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($cates['id'] == $vo['id']): ?>
                <li class="actived" value="<?php echo $vo['id']; ?>" ><?php echo $vo['cate_name']; ?></li>
                <?php else: ?>
                <li value="<?php echo $vo['id']; ?>"><?php echo $vo['cate_name']; ?></li>
                <?php endif; endforeach; endif; else: echo "" ;endif; else: ?>
                <li class="actived" value="<?php echo $cates['id']; ?>"><?php echo $cates['cate_name']; ?></li>
                <?php endif; ?>

                <!--<li class="actived"><?php echo $cates['cate_name']; ?></li>-->

            </ul>
            <div class="Tlist">
<?php if($cates['id'] == 28): if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <a href="<?php echo url('index/article/index',['id'=>$vo['id']]); ?>" class="Wnei row">
                    <img class="col s4 m3 l3 xl2" src="/static/uploads/<?php echo $vo['thumb']; ?>" alt="">
                    <div class="WneiD col s8 m9 l9 xl10">
                        <p class="Wp1 omit"><?php echo $vo['title']; ?></p>
                        <p class="Wp2 omit2"><?php echo mb_substr($vo['description'],0,80,'utf-8'); ?></p>
                        <p class="Wp3"><?php echo date('Y-m-d',$vo['addtime']); ?></p>
                    </div>
                </a>
                <?php endforeach; endif; else: echo "" ;endif; elseif($cates['id'] == 29): if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <a href="<?php echo url('index/article/index',['id'=>$vo['id']]); ?>" class="Tgai">
                    <div class="Znews">
                        <div class="Ztime">
                            <!--<div class="Tgai2">-->
                        ...
                        <div class="Zxin">
                            ...
                            <p class="Zdeta omit2"><?php echo mb_substr($vo['description'],0,100,'utf-8'); ?></p>
                        </div>
                    </div>
                </a>
                <?php endforeach; endif; else: echo "" ;endif; elseif($cates['id'] == 18): ?>
                <ul class="Zlist">
                ...
                <li><a href="<?php echo url('index/article/index',['id'=>$vo['id']]); ?>"><i class="Ttxt"><?php echo $vo['title']; ?></i><span class="Tday"><?php echo date('Y-m-d',$vo['addtime']); ?></span></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <!--<ul class="Zlist">-->
                    <!--<?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                    <!--<li><img src="/static/uploads/<?php echo $vo['thumb']; ?>"/><a href="<?php echo url('index/article/index',['id'=>$vo['id']]); ?>"><i class="Ttxt"><?php echo $vo['title']; ?></i><span class="Tday"><?php echo date('Y-m-d',$vo['addtime']); ?></span></a></li>-->
                    <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
                <!--</ul>-->
               <?php else: ?>
                <ul class="Zlist">
                    <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li><a href="<?php echo url('index/article/index',['id'=>$vo['id']]); ?>"><i class="Ttxt"><?php echo $vo['title']; ?></i><span class="Tday"></span></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
    ...
    <a href="http://222.88.154.53:8088/"><i class="WFicon3"></i><p>预约挂号</p></a>
    <a href="<?php echo url('index/about/index','id=3'); ?>"><i class="WFicon4"></i><p>联系我们</p></a>
    <div class="WFer"><img src="__index__/image/erweima.png" alt=""></div>
</div>
</div>
<script>
    // var  cid=<?php echo $cates['id']; ?>;

    $('#Ttab li').click(function(){
        $(this).addClass('actived').siblings().removeClass('actived');
        var val = $(this).val();

        window.location.href ="/cate/"+val+'.html'
    })
</script>
<!--底部导航栏-->
<!--底部导航栏-->
