<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\php\wamp\www\fubao\public/../application/admin\view\article\list.htm";i:1551772717;s:69:"D:\php\wamp\www\fubao\public/../application/admin\view\common\top.htm";i:1517578989;s:70:"D:\php\wamp\www\fubao\public/../application/admin\view\common\left.htm";i:1552007425;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>河南相映红
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo url('index/article/index',['id'=>$art['id']]); ?>" target="_blank"><?php echo cut_str($art['title'],10); ?></a></td>
                                <td align="center">
                                <?php if($art['thumb'] != ''): ?>
                                <img height="30" src="__uploads__/<?php echo $art['thumb']; ?>">
                                <?php else: ?>
                                暂无缩略图
                                <?php endif; ?>
                                </td>
                                <td align="center"><?php echo $art['cate_name']; ?></td>
                                <td align="center"><?php if($art['link_url'] != ''): ?> 是 <?php else: ?> 否 <?php endif; ?></td>
                                <td align="center"><?php if($art['show_top'] == 1): ?> 是 <?php else: ?> 否 <?php endif; ?></td>
                                <td align="center"><?php if($art['show_status'] == 1): ?> 是 <?php else: ?> 否 <?php endif; ?></td>
