<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\php\wamp\www\fubao\public/../application/index\view\doctor\index.htm";i:1552010884;s:70:"D:\php\wamp\www\fubao\public/../application/index\view\common\head.htm";i:1551858548;s:71:"D:\php\wamp\www\fubao\public/../application/index\view\common\right.htm";i:1551859553;s:72:"D:\php\wamp\www\fubao\public/../application/index\view\common\footer.htm";i:1551860516;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div class="Wtab wow bounceIn col s12 m12 l9 xl10">
            ...
            <div class="content-wrap">
                <div class="Wnei row Wyisheng" style="align-items: stretch;">
                    <div class="col s4 m2 l2 xl2" style="margin-right: 1rem;"><img style="border: 1px solid #ccc;
    padding: .6rem; margin: 0" src="/static/uploads/<?php echo $doc['pic_url']; ?>" alt=""></div>
...
<!--右侧-->
    ...
    <div class="Tongke hide-on-med-and-down wow bounceIn">
        ...
        <a class="Tongke-2" href="<?php echo url('index/doctor/index',array('id'=>$vo['id'])); ?>">
            ...
            <p class="Tongke-4 omit2"><i>擅长:</i><?php echo substr($vo['skilled'],0,100); ?></p>
        </a>
         <?php endforeach; endif; else: echo "" ;endif; ?>
...
<form method="post" action="<?php echo url('index/doctor/yuyue'); ?>" id="yuyue">
<div class="TPopup">
    <div class="Tlayer"></div>
    <div class="Tcontent">
        <div class="clearfix Wtousu">
            <div class="clearfix yisheng">
                <p>预约医生</p>
                <input type="text" value="" readonly="true" name="doctor">
            </div>
            <div class="clearfix shijian">
                <p>预约时间</p>
                <input type="text" value="" readonly="true" name="yytime">
            </div>
            <div class="clearfix">
                <p>姓名</p>
            ...
            <div class="clearfix">
                <p>电话</p>
                <input type="text" maxlength="16" name="mobile">
            </div>
            <div class="clearfix">
                <p>病情描述</p>
                <textarea cols="30" rows="10" name="symptom"></textarea>
            </div>
            <div class="clearfix">
                <p>验证码</p>
                <input style="display: inline;width: 25%;" type="text" name="code" class="pass-text-input " placeholder="请输入验证码">
                <b style="float: left;    height: 2.4rem;    width: 7.7rem;    margin-left: 1rem;    overflow: hidden;"><?php echo captcha_img(); ?></b>
                <!--<img src="<?php echo captcha_src(); ?>" alt="captcha" />-->
            </div>
            <div class="Tcontent-1 clearfix"><i  onclick="but()">预约</i> <i class="Tguanbi">关闭</i></div>
        </div>
    </div>
</div>
</form>
...
<script>
    $(window).ready(function() {
        var nana = "<?php echo $doc['name']; ?>";
        var shi = "";
        var VVV = ""
        $(".Xyisheng p a").click(function(){
            var HTIme = $(this).attr("data-time");
            var Hab = HTIme.charAt(HTIme.length-1);
            var H = HTIme.substring(0,HTIme.length-1);
            if(H==0){
                H=7
                VVV = $(".Xline p").eq(H).children(":first").html();
            }else {
                VVV = $(".Xline p").eq(H).children(":first").html();
            }
            ...
            $(".TPopup").show();
            $(".Tcontent .yisheng input").val(nana);
            $(".Tcontent .shijian input").val(VVV+" / "+shi);
            // $(".Tcontent .shijian input").attr("value",HTIme);

        })
        $(".Tguanbi,.Tlayer").click(function(){
            $(".TPopup").hide();
        })
    })
    function but(){
      ...
      $.ajax({
            ...
            url: "<?php echo url('index/doctor/yuyue'); ?>",//
            data: $('#yuyue').serialize(),//from表单 的id="login"
