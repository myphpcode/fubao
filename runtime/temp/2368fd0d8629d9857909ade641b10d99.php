<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\php\wamp\www\fubao\public/../application/index\view\article\index.htm";i:1551920189;s:70:"D:\php\wamp\www\fubao\public/../application/index\view\common\head.htm";i:1551858548;s:71:"D:\php\wamp\www\fubao\public/../application/index\view\common\right.htm";i:1551859553;s:72:"D:\php\wamp\www\fubao\public/../application/index\view\common\footer.htm";i:1551860516;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <title>安阳妇幼__<?php echo $cname; ?>__<?php echo $arts['title']; ?></title>
    ...
    <div class="row">
        <div class="Wtab wow bounceIn col s12 m12 l9 xl10">
            ...
            <div class="content-wrap PPbox">
                <h6><?php echo $arts['title']; ?></h6>
                <?php if(($arts['cate_id'] == 28) OR ($arts['cate_id'] == 29)): ?><p class="Wtime"><?php echo date('Y-m-d',$arts['addtime']); ?></p><?php endif; ?>
                <?php echo $arts['content']; ?>
            </div>
            <div class="Wup-and-down row">
   <?php if($prev == ''): ?>
                <a href="javascript:void(0)" class="col s12 m6 l6 xl6"><span class="omit">上一篇:没有了</span></a>
              <?php else: ?>
                <a href="<?php echo url('index/article/index',array('id'=>$prev)); ?>" class="col s12 m6 l6 xl6"><span class="omit">上一篇:<?php echo $prevt['title']; ?></span></a>
                <?php endif; if($next == ''): ?>
                <a href="javascript:void(0)" class="col s12 m6 l6 xl6"><span class="omit">下一篇:没有了</span></a>
                <?php else: ?>
                 <a href="<?php echo url('index/article/index',array('id'=>$next)); ?>" class="col s12 m6 l6 xl6"><span class="omit">下一篇:<?php echo $nextt['title']; ?></span></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
