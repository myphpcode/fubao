<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"F:\2019\fubao\public/../application/index\view\cate\index.htm";i:1551674170;s:62:"F:\2019\fubao\public/../application/index\view\common\head.htm";i:1551700570;s:63:"F:\2019\fubao\public/../application/index\view\common\right.htm";i:1551668460;s:64:"F:\2019\fubao\public/../application/index\view\common\footer.htm";i:1551509804;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="Wbox por container">
    <div class="row">
        <div class="Wtab tab3 wow bounceIn col s12 m12 l9 xl10">
            <ul class="tab-nav">
            ...
            <div class="content-wrap clearfix">
                <div class="content-item current">
                    ...
                    <a href="<?php echo url('index/article/index',['id'=>$vo['id']]); ?>" class="Wnei row Wjs">
                        <?php if(!empty($vo['thumb'])): ?>
                        <img class="col s4 m2 l2 xl2" src="/static/uploads/<?php echo $vo['thumb']; ?>" alt="">
                        <?php else: ?>
                        没有缩略图
                        <?php endif; ?>
                        <div class="WneiD col s8 m10 l10 xl10">
                            <p class="Wjieshao">标题：<?php echo $vo['title']; ?></p>

                            <p class="Wjieshao omit2">简介：<?php echo $vo['description']; ?></p>
