<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\php\wamp\www\fubao\public/../application/index\view\doctor\lst.htm";i:1551920024;s:70:"D:\php\wamp\www\fubao\public/../application/index\view\common\head.htm";i:1551858548;s:71:"D:\php\wamp\www\fubao\public/../application/index\view\common\right.htm";i:1551859553;s:72:"D:\php\wamp\www\fubao\public/../application/index\view\common\footer.htm";i:1551860516;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="Wbox por container">
    <div class="row">
        <div class="Wtab wow bounceIn col s12 m12 l9 xl10">
            <ul class="clearfix Wyuyue">
                <li class="actived">儿内科</li>
                <li>妇产科</li>
                <li>乳腺科</li>
                <li>生殖遗传</li>
                <li>耳鼻喉科</li>
            ...
            <script>
                ...
                $(function(){
                    ...
                    ykeshi = 0;
                    var url="<?php echo url('index/doctor/keshi'); ?>";
                    $.ajax({
                        url:url,
                        type:'POST', //GET
            ...
            <div class="content-wrap current" id="xcon">
    ...
    <div class="Wpaging wow bounceIn">
       <!--<?php echo $ldoc->render(); ?>-->
