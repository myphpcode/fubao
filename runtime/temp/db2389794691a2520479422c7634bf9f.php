<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\php\wamp\www\fubao\public/../application/index\view\about\index.htm";i:1551858533;s:70:"D:\php\wamp\www\fubao\public/../application/index\view\common\head.htm";i:1551858548;s:71:"D:\php\wamp\www\fubao\public/../application/index\view\common\right.htm";i:1551859553;s:72:"D:\php\wamp\www\fubao\public/../application/index\view\common\footer.htm";i:1551860516;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="Wbox por container">
    <div class="row">
        <div class="Wtab wow bounceIn col s12 m12 l9 xl10" id="Ttab">
            <ul class="clearfix">
                <?php if(is_array($abouts) || $abouts instanceof \think\Collection || $abouts instanceof \think\Paginator): $i = 0; $__LIST__ = $abouts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id']  == $about['id']): ?>
                <li class="actived"><?php echo $vo['title']; ?></li>
               <?php else: ?>
                <li><?php echo $vo['title']; ?></li>
                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div class="con">
            <div class="content-wrap PPbox" id="con1">
           <?php echo $about['content']; ?>
            </div>
            <!--<div class="content-wrap PPbox " id="con2">-->


             <!--22-->
            <!--</div>-->
            <!--<div class="content-wrap PPbox " id="con3">-->
