<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\php\wamp\www\fubao\public/../application/admin\view\article\edit.htm";i:1551766297;s:69:"D:\php\wamp\www\fubao\public/../application/admin\view\common\top.htm";i:1517578989;s:70:"D:\php\wamp\www\fubao\public/../application/admin\view\common\left.htm";i:1551858471;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>河南相映红</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="title" value="<?php echo $arts['title']; ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right:10px;">
                                    <label>
                                        <input name="show_top" value="1" <?php if($arts['show_top'] == 1): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                        <span class="text">是</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input name="show_top" value="0" <?php if($arts['show_top'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="description"><?php echo $arts['description']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">作者</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="author" value="<?php echo $arts['author']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">邮箱</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="email" value="<?php echo $arts['email']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">外链</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="link_url" value="<?php echo $arts['link_url']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($arts['thumb']): ?>
                                    <img src="__uploads__/<?php echo $arts['thumb']; ?>" height="30">
                                <?php else: ?>
                                    暂无缩略图
                                <?php endif; ?>
                            </div>
