...
Route::rule('doctor/:id','index/Doctor/index','get',['ext'=>'html|htm'],['id'=>'\d{1,3}']);
Route::rule('doctor','index/Doctor/lst','get',['ext'=>'html|htm'],['id'=>'\d{1,3}']);
//首页路由
Route::rule('index','index/Index/index','get',['ext'=>'html|htm']);
// Route::rule('category/:id','index/Category/index','get',['ext'=>'html|htm'],['id'=>'\d{1,3}']);
Route::rule('about/:id','index/about/index','get',['ext'=>'html|htm'],['id'=>'\d{1,3}']);
